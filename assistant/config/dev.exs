...
config :assistant,
  ...
  grobid_path: (if System.get_env("IN_CONTAINER") == "true" do "grobid:8070" else "localhost:8070" end),
...
config :assistant, AssistantWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/assistant_web/(live|views)/.*(ex)$",
      ~r"lib/assistant_web/templates/.*(eex)$"
    ]
  ]
